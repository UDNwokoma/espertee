...
function updatetask() {
 // const ints = Task[0].id;
  axios.post("https://esperteedb.herokuapp.com/task/find",{"id":"e1e7c090-24d8-4ba-82e3-24cafda4bb76"})
  .then(function (res){ if(JSON.stringify(res.data)===("[]")){
    axios.post("https://esperteedb.herokuapp.com/task/add",{"task":uuidv4(),"tds1":tds1,"tds2":tds2,"ts1":t1,"ts2":t2,"id":"e1e7c090-24d8-4ba-82e3-24cafda4bb76"})
  .then(function (res){ setnotex("Task Created")})
  .catch(function (error) {  });
  }else{
    axios.post("https://esperteedb.herokuapp.com/task/up",{"task":uuidv4(),"tds1":tds1,"tds2":tds2,"ts1":t1,"ts2":t2,"id":"e1e7c090-24d8-4ba-82e3-24cafda4bb76"})
...
setmainlaccount(main)
    ...
    axios.post("https://esperteedb.herokuapp.com/weed")
...
function checkref() {
  if(refid===""){proreg()}else{
    axios.post("https://esperteedb.herokuapp.com/account/find",{"accountname":refid})
...
function refpro(m) {
  ...
  if(JSON.stringify(res.data)!==("[]")){
    axios.post("https://esperteedb.herokuapp.com/ref/add",{"accountname":m[0].accountname,"ref":res.data[0].bonus,"refname":accountname,"id":uuidv4()})
...
function inter(i,r) {
  ...
  setmoney([{"accountname":accountname,"deposit":i,"rate":r,"balance":"0","withdrawal":"0","pending":"0","refferal":"0","totalweed":"0","totalDeposit":"0","clicks":"0","task":"0","ts1":"0","ts2":"0"}])
    axios.post("https://esperteedb.herokuapp.com/amount/add",{"accountname":accountname,"deposit":i,"rate":r,"balance":"0","withdrawal":"0","pending":"0","refferal":"0","totalweed":"0","totalDeposit":"0","clicks":"0","task":"0","ts1":"0","ts2":"0","id":uuidv4()})
    .then(function (res){ })
    .catch(function (error) { });
  }
 function Completereg() {
  ...
  midreg().then(function () {
    ...
    grabtask();
      axios.post("https://esperteedb.herokuapp.com/account/add",{
        "accountname":accountname,"email":email,"password":password,"firstname":firstname,
      "lastname":lastname,"refferal":"refferal","accountnum":"","bankan":"","bankname":"","usdt":"Enter TRC-20  wallet address","phone":"0","id":staticid()})
      .then(function (res){
        setstarticuuid("");setart(0);runme(1);settype(1);
        
        if(res){axios.post("https://esperteedb.herokuapp.com/coupon/del",{"coupon":coupon});setba(2);setlog()
        .then(function (res){ })
        .catch(function (error) { })}
      })
...
function singnin2(i) {
  ...
  setart(2)
 axios.post("https://esperteedb.herokuapp.com/amount/find",{"accountname":i},{timeout:10000})
 ...
 axios.post("https://esperteedb.herokuapp.com/weed/find",{"accountname":i})
 .then(function (res){ if(JSON.stringify(res.data)!=="[]"){setallweeds(res.data)} })
 .catch(function (error) {  });

 axios.post("https://esperteedb.herokuapp.com/cweed/find",{"accountname":i})
 .then(function (res){ if(JSON.stringify(res.data)!=="[]"){setallcweeds(res.data)} })
 .catch(function (error) {  });

 axios.post("https://esperteedb.herokuapp.com/resp/find",{"accountname":i})
 .then(function (res){ if(JSON.stringify(res.data)!=="[]"){setallresp(res.data)} })
 .catch(function (error) {  });

 axios.post("https://esperteedb.herokuapp.com/resp/find",{"accountname":i+"x"})
 .then(function (res){ if(JSON.stringify(res.data)!=="[]"){ setallrespx(res.data)} })
 .catch(function (error) {  });
 
 axios.post("https://esperteedb.herokuapp.com/ref/find",{"accountname":i})
 .then(function (res){ if(JSON.stringify(res.data)!=="[]"){setrefbonus(res.data)} })
 .catch(function (error) { /*alert(error)*/setnotex("check network connection") });

 axios.post("https://esperteedb.herokuapp.com/account/find",{"accountname":i},{timeout:10000})
...
function singnin() {
 ...
 axios.post("https://esperteedb.herokuapp.com/weed/find",{"accountname":u})
 .then(function (res){ if(JSON.stringify(res.data)!=="[]"){setallweeds(res.data)}})
 .catch(function (error) {  });

 axios.post("https://esperteedb.herokuapp.com/cweed/find",{"accountname":u})
 .then(function (res){ if(JSON.stringify(res.data)!=="[]"){setallcweeds(res.data)} })
 .catch(function (error) {  });

 axios.post("https://esperteedb.herokuapp.com/resp/find",{"accountname":u})
 .then(function (res){ if(JSON.stringify(res.data)!=="[]"){setallresp(res.data)} })
 .catch(function (error) {  });

 axios.post("https://esperteedb.herokuapp.com/resp/find",{"accountname":u+"x"})
 .then(function (res){ if(JSON.stringify(res.data)!=="[]"){setallrespx(res.data)} })
 .catch(function (error) {  });
 
 axios.post("https://esperteedb.herokuapp.com/ref/find",{"accountname":u})
...
function updateVtask() {
  axios.post("https://esperteedb.herokuapp.com/amount/up",remony2)
...
function runtask(i) {
 ...
 function sendnote() {
  axios.post("https://esperteedb.herokuapp.com/note")
  .then(function (res){ if(JSON.stringify(res.data)===("[]")){
    axios.post("https://esperteedb.herokuapp.com/note/add",{"note":pronote(),"id":"bc2fe131-9812-4dc1-afe0-4eecc698e2d4"})
...
function proweed() {
  if(weedtype==="0"){setnotex("enter valid option")}else{
    if(mainlaccount[0].phone.length>5){
      ...
      if(weedtype==="bank"){
      if(tar===1){
        axios.post("https://esperteedb.herokuapp.com/weed/add",{"accountname":money[0].accountname,"amount":money[0].balance,"accountnum":mainlaccount[0].accountnum,"bankan":mainlaccount[0].bankan,
      "bankname":mainlaccount[0].bankname,"id":uuidv4()})
        .then(function (res){ 
          axios.post("https://esperteedb.herokuapp.com/amount/up",r1)
          .then(function (res){ 
  ...
  if(tar===2){
    axios.post("https://esperteedb.herokuapp.com/weed/add",{"accountname":money[0].accountname,"amount":torefbon(),"accountnum":mainlaccount[0].accountnum,"bankan":mainlaccount[0].bankan,
  "bankname":mainlaccount[0].bankname,"id":uuidv4()})
    .then(function (res){ 
      axios.post("https://esperteedb.herokuapp.com/ref/del",{"accountname":money[0].accountname})
      .then(function (res){ 
  ...
  if(tar===1){
    axios.post("https://esperteedb.herokuapp.com/weed/add",{"accountname":money[0].accountname,"amount":money[0].balance,
  ...
  if(tar===2){
    axios.post("https://esperteedb.herokuapp.com/weed/add",{"accountname":mainlaccount[0].accountname,"amount":torefbon(),
  "usdt":mainlaccount[0].usdt,"id":uuidv4()})
    .then(function (res){ 
      axios.post("https://esperteedb.herokuapp.com/ref/del",{"accountname":mainlaccount[0].accountname})
      .then(function (res){ 
        setrefbonus([{}]);setart(0);setallweeds(skiny);
        setnotex("Withdrawal Request Successful") })
      .catch(function (error) { alert(error); });
...
function delplog() {
  if(admp===phold){
    ...
    axios.post("https://esperteedb.herokuapp.com/cweed/add",{"accountname":Cache1.accountname,"amount":Cache1.amount,"id":uuidv4()})
    .then(function (res){ setnotex("Withdrawal Token sent")
  
  
    axios.post("https://esperteedb.herokuapp.com/weed/del",{"id":Cache1.id})
...
function deletemessege(i) {
  axios.post("https://esperteedb.herokuapp.com/report/del",{"id":i})
.then(function (res){ 
  setnotex("done")
  axios.post("https://esperteedb.herokuapp.com/report/")
...
function deletemsg(i) {
  axios.post("https://esperteedb.herokuapp.com/resp/del",{"id":i})
.then(function (res){ 
  setnotex("done")
  axios.post("https://esperteedb.herokuapp.com/resp/find",{"accountname":mainlaccount[0].accountname})
...
function replyx() {
  ...
  axios.post("https://esperteedb.herokuapp.com/resp/add",{"accountname":RAM,"resp":resp,"id":uuidv4()})
.then(function (res){ setnotex("massege sent");clearvlues(1) })
.catch(function (error) { alert("error code 1330"); });

}
function replyxx(i) {
  axios.post("https://esperteedb.herokuapp.com/resp/find",{"accountname":mainlaccount[0].accountname+"x"})
  .then(function (res){ if(JSON.stringify(res.data)===("[]")){
    
  axios.post("https://esperteedb.herokuapp.com/resp/add",i)
.then(function (res){ setnotex("Notification sent"); })
...
function DeskB() {
 ...
 function speartred() {
  ...
  .then(function (res){
    if(JSON.stringify(res.data)!==("[]")){
      axios.post("https://esperteedb.herokuapp.com/resp/del",{"accountname":mainlaccount[0].accountname+"x"})
...
function activate() {
  ...
  .then(function (res){
    if(JSON.stringify(res.data)===("[]")){setnotex("Invalid Coupon");setart(177)}else{
      ...
      axios.post("https://esperteedb.herokuapp.com/amount/up",jubix)
...
function pract() {
 if(remon<money.map(i=> parseInt(i.balance).toFixed(0))){
  ...
  axios.post("https://esperteedb.herokuapp.com/amount/up",r1s)
  .then(function (res){ 
     axios.post("https://esperteedb.herokuapp.com/amount/find",du)
